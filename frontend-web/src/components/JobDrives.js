                        ...
                        <div className="space-y-2">
                          ...
                          {canManage && (
                            <button
                              ...
                              className="px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 transition-colors text-sm w-full"
                            >
                              Edit Drive
                            </button>
                          )}
                          
                          {/* View Applications button for PRs */}
                          <button
                            onClick={() => navigate(`/pr/job-drives/${drive._id}/applicants`)}
                            className="px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition-colors text-sm w-full"
                          >
                            View Applications ({drive.applications?.length || 0})
                          </button>
                        </div>
                      )}
