...
const StudentDashboard = () => {
  ...
  const fetchEligibleDrives = useCallback(async () => {
    try {
      ...
      console.log('Drives response status:', response.status);
      console.log('Drives response data:', response.data);
      ...
      console.log('Stats calculated:', { total, applied });
  ...
  const hasApplied = (drive) => {
    ...
    return drive.applications.some(app => {
      ...
      if (typeof app === 'object' && app !== null) {
        ...
        return studentId === userId || studentId === user?.id || studentId === user?._id;
      }
