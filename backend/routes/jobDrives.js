...
router.get('/:id/students', auth, async (req, res) => {
  try {
    ...
    const students = jobDrive.applications.map(app => ({
      name: app.student.profile?.name || 'N/A',
      rollNumber: app.student.profile?.rollNumber || 'N/A',
      department: app.student.profile?.department || 'N/A',
      cgpa: app.student.profile?.cgpa || 'N/A',
      phoneNumber: app.student.profile?.phoneNumber || 'N/A',
      degree: app.student.profile?.degree || 'N/A',
